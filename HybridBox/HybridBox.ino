...
{
    if (shieldButton.isPressed() && !isAirDodging && !xModButton.isPressed() && !yModButton.isPressed())
    {
        lsXOut = lsXRaw.getValue() * 0.6625;
